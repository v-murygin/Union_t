...
class MasterViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let navigateButton = UIBarButtonItem(title: "Reddit", style: .plain, target: self, action: #selector(self.navigateToRedditView))
        
        self.navigationItem.rightBarButtonItems = [addButton, navigateButton]
    ...
    @objc func navigateToRedditView() {
        let redditVC = DIContainer.shared.makeRedditViewController()
        navigationController?.pushViewController(redditVC, animated: true)
    }
